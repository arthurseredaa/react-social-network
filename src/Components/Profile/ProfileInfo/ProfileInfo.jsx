      ...
      <div className={s.descriptionBlock}>
        ...
        <div className={s.nameAndStatus}>
          ...
          <ProfileStatus
            ...
            editStatusText={props.editStatusText}
            newStatusText={props.newStatusText}
            cancelSetStatus={props.cancelSetStatus}
        ...
        <div className={s.jobAndContacts}>
          <div className={s.job}>
            ...
            <h3 className={s.jobStatus}>
              <span>Status: </span>
              {props.profile.lookingForAJob
                ? "В поиске работы"
                : "Не ищу работу"}
            </h3>
            <p className={s.jobStatusDescr}>
              <span>Details: </span>
          ...
          <div className={s.contacts}>
            ...
            {contacts.map((elem) => {
              return (
                <a key={nanoid(5)} href={props.profile.contacts[elem]}>
                  {elem}
                </a>
              );
            })}
